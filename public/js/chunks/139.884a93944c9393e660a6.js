...
/***/ "./frontend/src/assets/images/waiting.gif":
/*!************************************************!*\
  !*** ./frontend/src/assets/images/waiting.gif ***!
  \************************************************/
...
module.exports = "/images/waiting.gif";
      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          ...
          _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_6__["default"].login({
            ...
            var _response$data$token$ = response.data.token.original,
                access_token = _response$data$token$.access_token,
                user = _response$data$token$.user;
            _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_6__["default"].setToken(access_token); // // useJwt.setRefreshToken(response.data.refreshToken)

            localStorage.setItem('userData', JSON.stringify(user));

            _this.$ability.update(user.ability);

            _this.submitting = false; // ? This is just for demo purpose as well.
            // ? Because we are showing eCommerce app's cart items count in navbar
            // this.$store.commit('app-ecommerce/UPDATE_CART_ITEMS_COUNT', userData.extras.eCommerceCartItemsCount)
            // ? This is just for demo purpose. Don't think CASL is role based in this case, we used role in if condition just for ease

            _this.$router.replace(Object(_auth_utils__WEBPACK_IMPORTED_MODULE_8__["getHomeRouteForLoggedInUser"])(user.role)).then(function () {
              _this.$toast({
                component: _core_components_toastification_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_5__["default"],
                position: 'top-right',
                props: {
                  title: "Welcome ".concat(user.name),
                  icon: 'CoffeeIcon',
                  variant: 'success',
                  text: "You have successfully logged in as ".concat(user.role, ". Now you can start to explore!")
                }
              });
            });
            ...
            _this.$refs.loginForm.setErrors((error === null || error === void 0 ? void 0 : (_error$response = error.response) === null || _error$response === void 0 ? void 0 : _error$response.data) || 'Authentication failed!');
          });
        }
      });
    }
                                ...
                                _c(
                                  ...
                                  [
                                    !_vm.submitting
                                      ...
                                      : _c("img", {
                                          attrs: {
                                            src: __webpack_require__(/*! @/assets/images/waiting.gif */ "./frontend/src/assets/images/waiting.gif"),
                                            alt: ""
                                          }
                                        })
                                  ],
