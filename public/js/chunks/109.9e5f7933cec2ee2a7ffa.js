...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  actions: {
    ...
    uploadContacts: function uploadContacts(ctx, userData) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_0__["default"].post('/contacts-batch', _objectSpread({}, userData)).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
