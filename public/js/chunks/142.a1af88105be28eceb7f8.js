      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          ...
          _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_6__["default"].login({
            ...
            _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_6__["default"].setToken(response.data.accessToken); // useJwt.setRefreshToken(response.data.refreshToken)
                                  ...
                                  [
                                    !_vm.submitting
                                      ...
                                      : _c("img", {
                                          attrs: {
                                            src:
                                              "${require('@/assets/images/waiting.gif')}",
                                            alt: ""
                                          }
                                        })
                                  ],
