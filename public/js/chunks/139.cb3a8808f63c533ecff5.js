      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          ...
          _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_6__["default"].login({
            ...
            _this.$refs.loginForm.setErrors((error === null || error === void 0 ? void 0 : (_error$response = error.response) === null || _error$response === void 0 ? void 0 : _error$response.data) || 'Authentiation failed!');
          });
        }
      });
    }
