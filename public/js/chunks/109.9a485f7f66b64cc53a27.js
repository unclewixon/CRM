...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  actions: {
    ...
    uploadContacts: function uploadContacts(ctx, data) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_0__["default"].post('/contacts-batch', data).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
...
function useContacts() {
  ...
  var uploadContacts = function uploadContacts(data) {
    _store__WEBPACK_IMPORTED_MODULE_3__["default"].dispatch('app-contact/uploadContacts', data).then(function () {
      refetchData();
    })["catch"](function (e) {
      console.log(e.response);
      toast({
