...
/* harmony import */ var _core_mixins_ui_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @core/mixins/ui/forms */ "./frontend/src/@core/mixins/ui/forms.js");
/* harmony import */ var _store_index__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @/store/index */ "./frontend/src/store/index.js");
/* harmony import */ var _auth_utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/auth/utils */ "./frontend/src/auth/utils.js");
      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_3__["default"].login({
            ...
            _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_3__["default"].setToken(response.data.accessToken); // useJwt.setRefreshToken(response.data.refreshToken)
            ...
            _this.$router.replace(Object(_auth_utils__WEBPACK_IMPORTED_MODULE_7__["getHomeRouteForLoggedInUser"])(userData.role)).then(function () {
              _this.$toast({
