...
/* harmony import */ var _core_components_statistics_cards_StatisticCardWithLineChart_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @core/components/statistics-cards/StatisticCardWithLineChart.vue */ "./frontend/src/@core/components/statistics-cards/StatisticCardWithLineChart.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    StatisticCardWithLineChart: _core_components_statistics_cards_StatisticCardWithLineChart_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  data: function data() {
    return {
      contacts: {},
  ...
  created: function created() {
    ...
    // Contacts
    this.$http.get('/contacts-analytics').then(function (response) {
      _this.contacts = response.data.result;
    }); // Active Users

    this.$http.get('/sms-analytics').then(function (response) {
      _this.sms = response.data.result;
    }); // Active Users

    this.$http.get('/sms-delivered-analytics').then(function (response) {
      _this.delivered = response.data.result;
    });
  },
  methods: {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./frontend/src/pages/Dashboard.vue?vue&type=template&id=25ed164f&":
/*!*******************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./frontend/src/pages/Dashboard.vue?vue&type=template&id=25ed164f& ***!
  \*******************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
          ...
          _c(
            ...
            [
              _c("statistic-card-with-line-chart", {
                attrs: {
                  icon: "UserCheckIcon",
                  statistic: _vm.contacts.total || 0,
                  "statistic-title": "Contacts",
                  "chart-data": _vm.contacts.series
                }
              })
            ],
            1
            ...
            [
              _c("statistic-card-with-line-chart", {
                attrs: {
                  ...
                  color: "success",
                  statistic: _vm.sms.total || 0,
                  "statistic-title": "SMS Sent",
                  "chart-data": _vm.sms.series
                }
              })
            ],
            1
            ...
            [
              _c("statistic-card-with-line-chart", {
                attrs: {
                  ...
                  color: "success",
                  statistic: _vm.delivered.total || 0,
                  "statistic-title": "SMS Delivered",
                  "chart-data": _vm.delivered.series
                }
              })
            ],
            1
