          ...
          >
            ...
            >
              ...
              >
                ...
                <img
                  v-else
                  :src="require('@/assets/images/waiting.gif')"
                  alt=""
                >
              </b-button>
            </b-form>
      ...
      this.$refs.loginForm.validate().then(success => {
        if (success) {
          ...
          useJwt.login({
            ...
            .then(response => {
              const { access_token, user } = response.data.token.original
            ...
            .catch(error => {
              ...
              this.submitting = false
              this.$refs.loginForm.setErrors(error?.response?.data || 'Authentication failed!')
            })
        }
      })
    },
